                                                            ...
                                                            <li>
                                                                <label className="custom_check d-inline-flex">
                                                                    <input type="checkbox" name="online"/>
                                                                        <span className="checkmark"></span>
                                                                        <i className="feather-video online-icon"></i> Video Call
                                                                </label>
                                                            </li>
                                                            <li>
                                                                <label className="custom_check d-inline-flex">
                                                                    <input type="checkbox" name="online"/>
                                                                        <span className="checkmark"></span>
                                                                        <i className="feather-mic online-icon"></i> Audio Call
                                                                </label>
                                                            </li>
                                                            <li>
                                                                <label className="custom_check d-inline-flex">
                                                                    <input type="checkbox" name="online"/>
                                                                        <span className="checkmark"></span>
                                                                        <i className="feather-message-square online-icon"></i> Chat
                                                                </label>
                                                            </li>
                                                            <li>
                                                                <label className="custom_check d-inline-flex">
                                                                    <input type="checkbox" name="online"/>
                                                                        <span className="checkmark"></span>
                                                                        <i className="feather-users online-icon"></i> Instant Consulting
                                                                </label>
                                                            </li>
                                                        </ul>
                                                    </div>
                                        ...
                                        <div className="doctor-filter-inner">
                                            <div>
                                                <div className="doctors-found">
                                                    ...
                                                    <p><span>10 Doctors found for:</span> Dentist in India</p>
                                                </div>
                                                <div className="doctor-filter-availability">
                                                    ...
                                                    <div className="status-toggle status-tog">
                                                        <input type="checkbox" id="status_6" className="check"/>
                                                            <label for="status_6" className="checktoggle">checkbox</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="doctor-widget-one">
                                                <div className="doc-info-left">
                                                    <div className="doctor-img">
                                                        <a href="#">
                                                            <img src={user_img} className="img-fluid" alt="John Doe"/>
                                                        </a>
                                                    ...
                                                    <div className="doc-info-cont">
                                                        ...
                                                        <div className="clinic-details">
                                                            ...
                                                            <p className="doc-location">
                                                                <Award size={18}/> <span> &nbsp;20</span> Years of Experience
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
