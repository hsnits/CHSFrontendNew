...
const Sidebar = ({ UserDetails }) => {
  ...
  const { firstName, lastName, designation = "Registered Nurse", availability = false } = profile;

  const [isAvailability, setAvailability] = useState(availability);
        ...
        <div className="widget-profile pro-widget-content">
          <div className="profile-info-widget">
            <Link to="#" className="booking-nurse-img">
              <img src={UserDetails?.coverImage || nurse_img} alt="Nurse" />
            </Link>
            <div className="profile-det-info">
              <h3>
                <a href="#">RN {`${firstName || ""} ${lastName || ""}`}</a>
              </h3>
