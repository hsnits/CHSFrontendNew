                                            ...
                                            <ul className="care-list aos" data-aos="fade-up">
                                                <li>
                                                    ...
                                                    <div className="care-list-info">
                                                        ...
                                                        <p>Seamlessly onboard patients through our user-friendly registration process</p>
                                                        <p>Maintain accurate records and histories for better care coordination</p>
                                                    </div>
                                                </li>
                                                <li>
                                                    ...
                                                    <div className="care-list-info">
                                                        ...
                                                        <p>Keep patients informed about appointments, medication schedules, and follow-ups</p>
                                                ...
                                                <li>
                                                    ...
                                                    <div className="care-list-info">
                                                        ...
                                                        <p>Choose your preferred doctor, time, and clinic—all from your smartphone</p>
                                                    </div>
                                                </li>
                                                <li>
                                                    <span>4</span>
                                                    <div className="care-list-info">
                                                        ...
                                                        <p>Worried about that persistent cough? Our AI-powered symptom checker provides initial guidance.</p>
                                                        <p>Always consult a doctor, but let us help you understand your symptoms better</p>
                                                    </div>
                                                </li>
                                                <li>
                                                    <span>5</span>
                                                ...
                                                <li>
                                                    ...
                                                    <div className="care-list-info">
                                                        ...
                                                        <p>Coordinate with hospitals and manage paperwork efficiently</p>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
