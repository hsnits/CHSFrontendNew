      ...
      <div className="col-lg-8 col-md-12">
        ...
        <div className="paitent-appointment">
          <form action="#">
            ...
            <div className="forms-block">
              <label className="form-group-title">Care Needed</label>
              <textarea
                className="form-control"
                placeholder="Describe the type of nursing care needed (e.g., wound care, medication assistance, post-operative care, elderly care, etc.)"
            ...
            <div className="forms-block">
              <label className="form-group-title d-flex align-items-center">
                <i className="fa fa-paperclip me-2"></i> Medical Records/Prescription
              </label>
              <input
                type="file"
            ...
            <div className="forms-block">
              <label className="form-group-title">
                Current Condition <span>(Optional)</span>
              </label>
              <input
                type="text"
                className="form-control"
                placeholder="Brief description of current health condition"
