                                ...
                                <div className="profile-sidebar patient-sidebar profile-sidebar-new">
                                    ...
                                    <div className="dashboard-widget">
                                        ...
                                        <Nav variant="pills" className="flex-column dashboard-menu">
                                            ...
                                            <Nav.Item>
                                                <Nav.Link eventKey="second">  <i className="fa-solid fa-calendar-days"></i> My Appointments</Nav.Link>
                                            </Nav.Item>
                                            <Nav.Item>
                                                <Nav.Link eventKey="third">  <i className="fa-solid fa-shield-halved"></i> Health Report</Nav.Link>
                                            </Nav.Item>
                                            <Nav.Item>
                                                <Nav.Link eventKey="fourth">  <i className="fa-solid fa-user-pen"></i> Profile Settings</Nav.Link>
                                            </Nav.Item>
                                            <Nav.Item>
                                                <Nav.Link eventKey="fifth"> <i className="fa-solid fa-calendar-check"></i> Logout</Nav.Link>
                                            </Nav.Item>
                                        </Nav>
                                    </div>
                                </div>
                                            ...
                                            <div class="dashboard-card w-100">
                                                <div class="dashboard-card-head">
                                                    ...
                                                    <a href="javascript:void(0);">
                                                        <img src={user_img} class="avatar dropdown-avatar" alt="Img"/>
                                                            &nbsp; &nbsp;Hendrita
                                                    </a>
                                                </div>
                                                <div class="dashboard-card-body">
                                                    <div class="account-detail-table">
                                                        <nav class="patient-dash-tab border-0 pb-0 mb-3 mt-3">
                                                            <ul class="nav nav-tabs-bottom" role="tablist">
                                                                <li class="nav-item" role="presentation">
                                                                    <a class="nav-link" href="#appoint-tab" data-bs-toggle="tab" aria-selected="false" role="tab" tabindex="-1">Appointments</a>
                                                                </li>
                                                                <li class="nav-item" role="presentation">
                                                                    <a class="nav-link" href="#medical-tab" data-bs-toggle="tab" aria-selected="false" tabindex="-1" role="tab">Medical Records</a>
                                                                </li>
                                                                <li class="nav-item" role="presentation">
                                                                    <a class="nav-link active" href="#prsc-tab" data-bs-toggle="tab" aria-selected="true" role="tab">Prescriptions</a>
                                                                </li>
                                                            </ul>
                                                        </nav>
                                                        ...
                                                        <div class="tab-content pt-0">
                                                            ...
                                                            <div id="appoint-tab" class="tab-pane fade" role="tabpanel">
                                                            ...
                                                            <div class="tab-pane fade active show" id="prsc-tab" role="tabpanel">
                                                                <div class="custom-table">
                                                                    <div class="table-responsive">
                                                                        <table class="table table-center mb-0">
                                                                            <thead>
                                            ...
                                            <Col xl='12' className="d-flex">
                                                <div className="dashboard-card w-100">
                                                    <div className="dashboard-card-head">
                                                        ...
                                                        <a href="javascript:void(0);">
                                                            <img src={user_img} className="avatar dropdown-avatar" alt="Img" />
                                                            &nbsp; &nbsp; Hendrita
                                                        </a>
                                                    </div>
